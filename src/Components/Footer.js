...
import bg_video from "../Static/Videos/background.mp4";
    ...
    <footer className="footer">
      ...
      <div className="container">
            ...
            <div className="layout">
              <div className="layout_item w-50">
                <div className="newsletter">
                  <h3 className="newsletter_title">Apply For Newsletter</h3>
                  <form action="">
              ...
              <div className="layout_item w-25">
                <nav className="c-nav-tool">
                  ...
                  <ul className="c-nav-tool_list">
                    <li>
                      <Link to="/web_dep/" className="c-link">
                        Home
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link to="/courses" className="c-link">
                        Courses
                      </Link>
                    </li>
                    <li>
                      <Link to="/services" className="c-link">
                        Services
                      </Link>
                    </li>
                  </ul>
        ...
        <div className="footer_copyright">
          <p>&copy; 2024 Advanced Institute Of Aesthetics</p>
        </div>
      </div>
    </footer>
  );
